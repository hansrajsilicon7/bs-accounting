...
?>
  ...
  <div class="modal fade" id="myModal" role="dialog">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><span class="fa fa-edit"> Edit Location</span></h1>
			</div>
		</div><!--/.row-->
        ...
        <!-- end php -->
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form"  method="post" action="query/update_location.php"  enctype="multipart/form-data">
                            	<div class="form-group">
									<label>ID</label>
									<input type="text" class="form-control" readonly="readonly" name="id" value="<?php echo $r['id']; ?>"  >
								</div>
								<div class="form-group">
									<label>City</label>
									<input type="text" class="form-control" name="city"  required="" value="<?php echo $r['city']; ?>">
								</div>
                                <div class="form-group">
									<label>Address</label>
									<textarea class="form-control" required="" rows="4" name="address"><?php echo $r['address']; ?></textarea>
								</div>
								...
								<div class="form-group upload-btn-wrapper">
                                	<div class="row">
                                    	<div class="col-md-4 col-sm-12">
                                        	<img  src="<?php echo 'query/'.$r['photo']; mysqli_close($con);?>" class="img-rounded" alt="No Image" width="140" height="120"/>	
                                        </div>
                                        <div class="col-md-8 col-sm-12">
                                        	<label>Upload Photo</label>
                                 			<input type="file"  name="photo" id="imgfile" class="color-orange"/><br>
									...
									<a href="edit_delete_location.php" class="btn btn-warning">Back</button></a>
                             <!--Confirmation Modal -->
